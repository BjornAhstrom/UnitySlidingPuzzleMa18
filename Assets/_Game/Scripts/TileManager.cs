...
public class TileManager : MonoBehaviour
{
    ...
    public bool TilePressed(GameObject tile, bool shuffle)
    {
        ...
        SwitchTile(tile, emptyNeighbour, speed);
        return true;
    ...
    private void SwitchTile(GameObject tile1, GameObject tile2, float speed)
    {
        ...
        LeanTween.move(tile1, tile2.transform.position, speed).setEaseInCubic().setOnComplete(() => { inputLock = false; });
